...
This file aligns development of the **KION Music** provider with the
...
provider (someone editing `music_assistant/providers/kion_music/` directly in
...
`music_assistant/providers/kion_music` upstream eventually — that is the
