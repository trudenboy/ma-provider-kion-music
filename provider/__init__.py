...
def _wave_preset_config_entries(values: dict[str, ConfigValueType]) -> list[ConfigEntry]:
    ...
    return [
        ConfigEntry(
            ...
            label=(f"My Mix presets ({len(presets)} saved)" if has_presets else "My Mix presets"),
            advanced=True,
        ),
        ConfigEntry(
...
async def get_config_entries(
    ...
    if not is_authenticated:
        label_text = (
            ...
            "or scan a QR code with the Kion app on your phone.\n\n"
        ...
        label_text = "Authenticated to KION Music. Don't forget to save to complete setup."
    else:
        label_text = "Authenticated to KION Music."
    ...
    return (
        ...
        ConfigEntry(
            ...
            description="Opens a QR code page — scan it with the Kion app on your phone.",
        ...
        *_wave_preset_config_entries(values),
        ...
        ConfigEntry(
            ...
            "triggering Kion smart-captcha. Lower values load faster. "
            "Default: 200.",
            range=(50, 2000),
            default_value=200,
            required=False,
