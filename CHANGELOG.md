...
- Updated parser snapshots for current Music Assistant transcript metadata.
...
- Align provider validation with Music Assistant's shared task scheduling and lifecycle behavior, including concurrent recommendation request deduplication.

## [3.0.7] - 2026-08-11

### Fixed

- Keep expired mood and activity tag lists available while refreshing them so recommendation subtitles continue to match independently loaded items.
