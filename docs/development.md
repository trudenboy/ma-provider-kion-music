...
```
feature/offline-download-support
...
git checkout -b feature/offline-download-support
...
# 3. PR: feature/* → dev
git push origin feature/offline-download-support
gh pr create --base dev --title "feat: add offline download support"

# 4. CI passes → merge → delete branch
git push origin --delete feature/offline-download-support
```
