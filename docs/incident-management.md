...
# KION Music — Управление инцидентами

## Куда заводить инциденты

> **Заводи задачи здесь:** [github.com/trudenboy/ma-provider-kion-music/issues](https://github.com/trudenboy/ma-provider-kion-music/issues)
...
- **Поле Provider**: устанавливается автоматически для KION Music
