#!/bin/sh
# Init script for KION Music provider Docker dev environment.
# Auto-generated by ma-provider-tools — do not edit manually.
set -e

echo "==> Setting up KION Music provider..."
...
rm -rf "${PROVIDERS_DIR}/kion_music"
ln -s /tmp/provider "${PROVIDERS_DIR}/kion_music"
echo "==> Provider linked: ${PROVIDERS_DIR}/kion_music"
