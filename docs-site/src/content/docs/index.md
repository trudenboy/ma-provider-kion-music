...
:::caution[Дисклеймер]
Это неофициальная реализация, не связанная с компанией МТС или KION.
:::

:::note[Подписка]
Для проигрывания Lossless FLAC необходимо наличие подписки [KION](https://kion.ru). Без подписки провайдер автоматически переключается на наилучший доступный формат (MP3 320 kbps).
:::
