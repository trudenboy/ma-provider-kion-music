...
:::note[Требуется подписка для Lossless]
Качество **Superb (FLAC Lossless)** доступно только с активной подпиской **KION**. Без подписки провайдер автоматически переключается на MP3 320 kbps.
:::
