...
# KION Music — локальная разработка через Docker

Запусти полноценный Music Assistant с провайдером KION Music одной командой —
...
## Подключение провайдера KION Music

После входа:

1. Перейди в **Settings** → **Providers**
2. Найди **KION Music** в списке — он уже доступен, код загружен автоматически
