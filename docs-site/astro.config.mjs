...
export default defineConfig({
	site: 'https://trudenboy.github.io/ma-provider-kion-music',
	base: '/ma-provider-kion-music',
	integrations: [
		starlight({
			title: 'KION Music · MA Provider',
			locales: {
			...
			defaultLocale: 'root',
			editLink: {
				baseUrl: 'https://github.com/trudenboy/ma-provider-kion-music/edit/dev/docs-site/src/content/docs/',
			},
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/trudenboy/ma-provider-kion-music' },
			],
			sidebar: [
